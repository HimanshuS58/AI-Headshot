...
const UploadCard = ({
    ...
    const uploadFile = async (file: File) => {
        ...
        try {
            ...
            onUploadError(new Error('Uploading failed'))
        }
    }

    const onDrop = (acceptedFiles: File[]) => {
        if(acceptedFiles.length === 0){
            onUploadError(new Error('Please upload a JPG, PNG, WEBP'));
            return
        }
    ...
    return (
        <section id="upload" className='px-4 py-12'>
            <div className='mx-auto max-w-2xl'>
                <h2 className='mb-2 text-center text-2xl font-semibold'>Upload your selfie</h2>
                ...
                <div 
                   ...
                   className={cn('glass-card relative flex cursor-pointer flex-col items-center gap-6 p-10 transition',
                    ...
                    <div className='text-center'>
                        ...
                        <p className='mt-1 text-sm text-white/50'>or click to browse · JPG, PNG, or WEBP</p>
                    </div>
